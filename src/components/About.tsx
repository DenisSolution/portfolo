...
import selfie from '../images/my.png';
...
export const About = (props: Props) => {
  return (
    <Wrapper>
      <AboutMe>
        <span>
          Hello! I&apos;m a talented front-end developer using
          <SnazzyText> react, typescript </SnazzyText>in the  web
          development.
        </span>
        <span>
          While you're at it, you can check out my
          <Link href="https://github.com/michaelsolution627"> GitHub</Link>!
        </span>
        <span>
        ...
        <span>
          I also LOVE writing <SnazzyTextPink> NIFTY </SnazzyTextPink>CSS - sass, scss, styled-component.
        </span>
